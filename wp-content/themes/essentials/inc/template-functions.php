						...
						<div class="row d-flex justify-content-center">
							<div class="col-12 col-md-12">
								<div class="pix-overlay-item pix-overlay-item--style-6">
									<a href="#" class="pix-search-close"><span class="screen-reader-text sr-only"><?php echo esc_attr__( 'Close', 'essentials' ); ?></span><i class="text-white pixicon-close-circle"></i></a>
...
if ( !function_exists( 'pix_popup_content' ) ) {
	function pix_popup_content() {
		...
		if( class_exists( '\Elementor\Plugin' ) ) {
			if ( Elementor\Plugin::instance()->documents->get($id)->is_built_with_elementor() ) {
