...
function pixfort_activation_notice() {
    ...
    <div class="notice pixfort-admin-notice notice-warning2 is-dismissible">
        ...
        <a href="<?php echo esc_url( admin_url('?page=pixfort-dashboard') ); ?>" class="button button-primary"><?php esc_html_e( 'Go to Essentials Dashboard', 'essentials' ); ?></a>
        <br />
    </div>
    <?php
}
    ...
    <div class="pixfort-admin-notice pixfort-danger-notice  notice  notice-danger  is-dismissible2">
        <div class="notice-grid">
            ...
            <div>
                ...
                <a href="<?php echo esc_url( admin_url('?page=pixfort-dashboard') ); ?>" class="button-danger"><?php esc_html_e( 'Go to Essentials Dashboard', 'essentials' ); ?></a>
            </div>
            </div>
...
function pixfort_url_change_options_notice() {
    ...
    <div class="pixfort-admin-notice  notice  notice-warning  is-dismissible">
            ...
            <a href="<?php echo esc_url( admin_url('admin.php?page=pixfort') ); ?>" class="button"><?php esc_html_e( 'Go to Theme options', 'essentials' ); ?></a>
    	</div>
    <?php
}
                ...
                <div>
                    ...
                    $status = $pixfortHub->checkValidation();
                        if($status){
                            ...
                            <div class="text-center">
                                <a href="#" class="pix-theme-deactivate"><?php esc_html_e( 'Deactivate theme', 'essentials' ); ?></a>
                            </div>
                            <?php
                        }else{
                            ?>
                        ...
                        <div class="pix-dashboard-alert">
                            <strong><?php esc_html_e( 'Note:', 'essentials' ); ?></strong> <?php esc_html_e( 'if this is your staging site and you want to activate this license later on the production domain (for the same end product) you should deactivate it from here first', 'essentials' ); ?> <a href="https://essentials.pixfort.com/knowledge-base/deactivate-your-license/" target="_blank"><?php esc_html_e( 'Check this article', 'essentials' ); ?></a>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="pix-useful-items">
                            <a href="<?php echo esc_url( admin_url('admin.php?page=pix-one-click-demo-import') ); ?>" class="useful-item">
                                <div class="useful-item-inner">
                                    <div class="useful-title"><?php esc_html_e( 'Import Demo Content', 'essentials' ); ?></div>
                        ...
                        <div class="pix-useful-items pix-changelog">
                            <a target="_blank" href="https://essentials.pixfort.com/knowledge-base/changelog/#pix_section_changelog" class="useful-item">
                                <div class="useful-item-inner">
                                    <div class="useful-title"><?php esc_html_e( 'Changelog', 'essentials' ); ?> v<?php echo esc_attr(ESSENTIALS_THEME_VERSION); ?></div>
                        ...
                        <div class="pix-useful-items">
                            <a target="_blank" href="http://hub.pixfort.com/" class="useful-item">
                                <div class="useful-item-inner">
                                    ...
                                    <div class="useful-text"><?php esc_html_e( 'Get support and manage your licenses', 'essentials' ); ?></div>
                                </div>
                            </a>
                            <div class="useful-item">
                                <div class="useful-item-inner">
                                    <div class="useful-title"><?php esc_html_e( 'Social', 'essentials' ); ?></div>
                                    <div class="useful-text social-links">
                                        ...
                                        <a href="https://www.linkedin.com/company/pixfort" target="_blank"><?php esc_html_e( 'Linkedin', 'essentials' ); ?></a>,
