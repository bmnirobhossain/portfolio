	...
	public function generate() {
		...
		if ( isset( $this->attrs['topDivider'] ) ) {
			...
			if ( isset( $divider['type'] ) && 'none' !== $divider['type'] ) {
				...
				if ( isset( $divider['color'] ) && ! isset( $divider['colorMode'] ) || ( isset( $divider['colorMode'] ) && 'gradient' !== $divider['colorMode'] ) ) {
					$this->inject_style(
						array(
		...
		if ( isset( $this->attrs['bottomDivider'] ) ) {
			...
			if ( isset( $divider['type'] ) && 'none' !== $divider['type'] ) {
				...
				if ( isset( $divider['color'] ) && ( ! isset( $divider['colorMode'] ) ) || 'gradient' !== $divider['colorMode'] ) {
					$this->inject_style(
						array(
