...
class Form {
	...
	public function enqueue_script() {
		...
		if ( self::POST_TYPE === $screen->post_type ) {
			$include = include GUTENVERSE_DIR . '/lib/dependencies/form.asset.php';
			$include = apply_filters( 'gutenverse_include_form', $include );
			...
			wp_set_script_translations( 'gutenverse-form', 'gutenverse', GUTENVERSE_LANG_DIR );
