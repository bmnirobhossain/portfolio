...
function pixfort_theme_option_notice() {
    ...
    $pix_popups_options_fields = array(
        array(
            'id'       => 'pix-exit-popup',
            'type'     => 'select',
    ...
    $pix_popups_options_fields = array_merge(
        $pix_popups_options_fields,
        array(
            array(
                'id'       => 'pix-preload-page-popups',
                'type'     => 'switch',
                'title'    => __('Preload page Popups', 'pixfort-core'),
                'desc' => __('Enabling Popups preloading will load the page popups content with the page to reduce the delay before displaying the requested Popup.', 'pixfort-core'),
                'default'  => false,
            ),
        )
    );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'         => 'exit_popup',
        'subsection' => true,
        'fields'     => $pix_popups_options_fields
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        $pix_transition_options_fields = 
            array(
                ...
                array(
                    ...
                    'type'     => 'switch',
                    'title'    => __('Disable loading animation', 'pixfort-core'),
                    'default'  => false,
                ),
        ...
        $pix_transition_options_fields = array_merge(
            $pix_transition_options_fields,
            array(
                array(
                    'id'       => 'site-loading-style',
                    'type'     => 'select',
                    'title'    => __('Loading animation style', 'pixfort-core'),
                    // 'subtitle' => __('The transition when entering/leaving the page.', 'pixfort-core'),
                    'default'   => 'default',
                    'options'  => array(
                    ...
                    'required' => array('site-disable-loading-icon','!=',true),
                ),
                array(
                    'id'       => 'site-loading-img',
                    'type'     => 'media',
                    'url'      => true,
                    'title'    => __('Custom Loading image', 'pixfort-core'),
                    'required' => array('site-loading-style','=','style-8'),
                ),
                array(
                    'id'       => 'site-loading-img-width',
                    'type'     => 'text',
                    'title'    => __( 'Custom Loading image width', 'pixfort-core' ),
                    'subtitle' => __('Add custom loading image width with unit, for example: 200px.<br>Leave empty to use the default image size.', 'pixfort-core'),
                    'default'  => '',
                    'required' => array('site-loading-style','=','style-8'),
                ),
            )
        ...
        Redux::setSection( $opt_name, array(
            ...
            'id'         => 'page_transition',
            'subsection' => true,
            'fields'     => $pix_transition_options_fields
        ) );
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields'     => array(
                ...
                array(
                    'id'       => 'pix-enable-elementor-loader',
                    'type'     => 'switch',
                    'title'    => __('Enable direct Elementor loader', 'pixfort-core'),
                    'desc' => __('If you are facing issues with loading Elementor parts of the site because of any external third party plugins you can enable this option for direct Elementor builder loading.', 'pixfort-core'),
                    'default'  => false,
                ),

                array(
                    'id'       => 'pix-disable-elementor-theme-fonts',
                    'type'     => 'switch',
                    'title'    => __('Disable adding theme fonts inside Elementor', 'pixfort-core'),
                    // 'desc' => __('If you are facing issues with loading Elementor parts of the site because of any external third party plugins you can enable this option for direct Elementor builder loading.', 'pixfort-core'),
                    'default'  => false,
                ),
            )
        ...
        $pix_advanced_options_fields = array(
            array(
            ...
            // array(
            //     'id'       => 'pix-disable-beta-features',
            //     'type'     => 'switch',
            //     'title'    => __('Disable Beta features', 'pixfort-core'),
            //     'desc' => __('Enabling this option will disable the new Beta features, you can enable this option if you are facing any issues with new features.', 'pixfort-core'),
            //     'default'  => false,
            // ),
        ...
        $pix_advanced_options_fields = array_merge(
            $pix_advanced_options_fields,
            array(
                array(
                    'id'       => 'pix-custom-cursor',
                    'type'     => 'switch',
                    'title'    => __('Enable custom cursor', 'pixfort-core'),
                    'default'  => false,
                ),
                array(
                    'id'       => 'pix-cursor-color',
                    'type'     => 'select',
                    'title'    => __('Cursor background color', 'pixfort-core'),
                    'default'  => 'default',
                    'options'  => array_merge(
                        array(
                            'default'   => 'Default',
                    ...
                    'required' => array('pix-custom-cursor','!=',false),
                ),
                array(
                    'id'       => 'pix-disalbe-default-cursor',
                    'type'     => 'switch',
                    'title'    => __('Disable default cursor', 'pixfort-core'),
                    'default'  => false,
                    'required' => array('pix-custom-cursor','!=',false),
                ),
            )
        ...
        Redux::setSection( $opt_name, array(
            ...
            'subsection' => true,
            'fields'     =>  $pix_advanced_options_fields
        ));
            ...
            Redux::setSection( $opt_name, array(
                ...
                Redux::setSection( $opt_name, array(
                    ...
                    'fields'     => array(
                        ...
                        array(
                            ...
                            'transparent' => false,
                            'default'  => '#FFFFFF',
                            'required' => array('banner-bg','equals','custom'),
                            'validate' => 'color',
                        ),
                ...
                Redux::setSection( $opt_name, array(
                    ...
                    'fields'     => array(
                        ...
                        array(
                            'id'       => 'search-dark-overlay',
                            'type'     => 'switch',
                            'title'    => __('Use dark Search overlay text colors', 'pixfort-core'),
                            // 'desc' => __('You can edit the primary gradient color in the colors section (left menu)', 'pixfort-core'),
                            'default'  => false,
                        ),
                ...
                Redux::setSection( $opt_name, array(
                    ...
                    Redux::setSection( $opt_name, array(
                        ...
                        'fields'     => array(
                            ...
                            array(
                                'id'       => 'pix-blog-related-style',
                                'type'     => 'image_select',
                                'width'     => '150px',
                                'height'     => '100px',
                                'title'    => __('Related Posts Style', 'pixfort-core'),
                                'options'  => array(
                                    'default'      => array(
                                        'title'   => __('Default', 'pixfort-core'),
                                        'img'   => $pixReduxFramework.'assets/img/options/style-default.jpg'
                    ...
                    Redux::setSection( $opt_name, array(
                        ...
                        'fields'     => array(
                            ...
                            array(
                                ...
                                'type'     => 'switch',
                                'title'    => __('Navigation in same category', 'pixfort-core'),
                                'desc'     => __('Navigation arrows refer to projects in the same category', 'pixfort-core'),
                                'default'  => false,
                                'required' => array('portfolio-navigation','!=',false),
                            ),
                            array(
                    ...
                    Redux::setSection( $opt_name, array(
                        'title'      => __( 'General', 'pixfort-core' ),
                        'desc'       => __( 'For detailed information about the theme typography please check this article from our knowledge base: ', 'pixfort-core' ) . '<a target="_blank" href="https://essentials.pixfort.com/knowledge-base/theme-typography/" target="_blank">https://essentials.pixfort.com/knowledge-base/theme-typography/</a>',
                        ...
                        'fields'     => array(
                            array(
                                ...
                                'subtitle' => __( 'Primary font for texts and paragraphs', 'pixfort-core' ),
                                'google'      => true,
                                'font-backup' => true,
                            ...
                            array(
                                ...
                                'type'     => 'text',
                                'title'    => __( 'Body font spacing', 'pixfort-core' ),
                                // 'subtitle' => __( 'Type your LinkedIn link here', 'pixfort-core' ),
                            ...
                            array(
                                ...
                                'type'     => 'text',
                                'title'    => __( 'Default font weight', 'pixfort-core' ),
                                'desc'     => __( 'Default regular font weight is 400', 'pixfort-core' ),
                                'default'   => ''
                            ),
                            array(
                                'id'       => 'opt-bold-font-weight',
                                'type'     => 'text',
                                'title'    => __( 'Default Bold font weight', 'pixfort-core' ),
                                'desc'     => __( 'Default bold font weight is 700', 'pixfort-core' ),
                                'default'   => ''
                            ),

                            array(
                                'id'       => 'opt-heading-font-weight',
                                'type'     => 'text',
                                'title'    => __( 'Heading custom font weight', 'pixfort-core' ),
                                'desc'     => __( 'Leave empty to use the default font weight', 'pixfort-core' ),
                                'default'   => ''
                            ),
                            array(
                                'id'       => 'opt-heading-bold-font-weight',
                                'type'     => 'text',
                                'title'    => __( 'Heading custom Bold font weight', 'pixfort-core' ),
                                'desc'     => __( 'Leave empty to use the default bold font weight', 'pixfort-core' ),
                                'default'   => ''
                            ),
