...
function twentig_block_editor_assets() {
	...
	$config = apply_filters(
		...
		array(
			...
			'spacing_support' => current_theme_supports( 'tw-spacing' ),
...
function twentig_override_block_styles() {
	...
	$overriden_blocks = apply_filters(
...
function twentig_enqueue_block_styles() {
	...
	$styled_blocks = apply_filters(
		'twentig_additional_block_styles', 
		[
			'navigation',
			'cover',
			'image',
...
function twentig_get_spacing_sizes() {
	...
	$sizes = array(
		[ 'slug' => '0', 'name' => '0px', 'size' => '0px' ],
		[ 'slug' => '1', 'name' => '5px', 'size' => '5px' ],
		[ 'slug' => '2', 'name' => '10px', 'size' => '10px' ],
		[ 'slug' => '3', 'name' => '15px', 'size' => '15px' ],
		[ 'slug' => '4', 'name' => '20px', 'size' => '20px' ],
		[ 'slug' => '5', 'name' => '30px', 'size' => '30px' ],
		[ 'slug' => '6', 'name' => '40px', 'size' => '40px' ],
		[ 'slug' => '7', 'name' => '50px', 'size' => '50px' ],
		[ 'slug' => '8', 'name' => '60px', 'size' => '60px' ],
		[ 'slug' => '9', 'name' => '80px', 'size' => '80px' ],
		[ 'slug' => '10', 'name' => '100px', 'size' => '100px' ],
		[ 'slug' => 'auto', 'name' => 'auto', 'size' => 'auto' ],
	);
...
function twentig_filter_columns_block( $block_content, $block ) {
	...
	if ( twentig_theme_supports_spacing() && $horizontal_gap && false !== strpos( $horizontal_gap, 'px' ) ) {
