...
class Post_Module_1{
    ...
    public function get_attributes($default = false) {
        ...
        $attributes = array(
            ...
            'titleLgTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'24', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'0', 'unit'=>'px'], 'height'=>(object)[ 'lg'=>'32', 'unit'=>'px'],'decoration'=>'none','transform' => '','family'=>'','weight'=>'500'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'titleTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'14', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'0', 'unit'=>'px'], 'height'=>(object)['lg'=>'22', 'unit'=>'px'],'transform' => '', 'decoration'=>'none','family'=>'','weight'=>'500'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'imgWidth' => [
                'type' => 'object',
                'default' => (object)['lg' =>'80', 'sm' =>'65', 'xs' =>'', 'ulg' =>'px', 'usm' =>'px'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'showImage','condition'=>'==','value'=>true],
            ...
            'imgHeight' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-small-post-module1 .ultp-block-item .ultp-block-image img {height: {{imgHeight}}; }'
                    ],
                ],
            ],
            'imageScale' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-small-post-module1 .ultp-block-item .ultp-block-image img {object-fit: {{imageScale}};}'
                    ],
                ],
            ],
            'imgAnimation' => [
            ...
            'imgRadius' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-image img, {{ULTP}} .ultp-block-image.ultp-block-image-overlay >a:before, {{ULTP}} .ultp-block-image.ultp-block-image-overlay >a:after{ border-radius:{{imgRadius}}; }'
                    ],
                ],
            ],
            'imgHoverRadius' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>' {{ULTP}} .ultp-block-item:hover .ultp-block-image img, {{ULTP}} .ultp-block-item:hover .ultp-block-image.ultp-block-image-overlay >a:before, {{ULTP}} .ultp-block-item:hover .ultp-block-image.ultp-block-image-overlay >a:after
                        { border-radius:{{imgHoverRadius}}; }'
                    ],
                ],
            ],
            'imgShadow' => [
                        ...
                        while ( $recent_posts->have_posts() ): $recent_posts->the_post();
                            ...
                            $post_loop .= '<'.$attr['contentTag'].' class="ultp-block-item post-id-'.$post_id.'">';
                                ...
                                $post_loop .= '<div class="ultp-block-content-wrap">';
                                    if((has_post_thumbnail() || $attr['fallbackEnable']) && $attr['showImage'] && ($idx == 0 || $attr['layout'] == 'layout2' || $attr['layout'] == 'layout3' || $attr['layout'] == 'layout5')) {
