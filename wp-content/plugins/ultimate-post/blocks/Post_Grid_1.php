                ...
                $wraper_before .= '<div class="ultp-block-wrapper">';
                    ...
                    $idx = ($attr['paginationShow'] && ($attr['paginationType'] == 'loadMore')) ? ( $noAjax ? 1 : 0 ) : 0;
                        while ( $recent_posts->have_posts() ): $recent_posts->the_post();
                            ...
                            /* $attr['fallbackEnable'] || $attr['showImage'] && $attr['fallbackEnable'] ? $attr['showImage'] : has_post_thumbnail() */

                                $post_loop .= '<div class="ultp-block-content-wrap">';
                                    if((has_post_thumbnail() || $attr['fallbackEnable']) && $attr['showImage'] && $attr['layout'] != 'layout2') {
