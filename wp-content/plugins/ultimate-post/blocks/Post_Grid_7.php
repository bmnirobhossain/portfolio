...
class Post_Grid_7{
    ...
    public function get_attributes($default = false) {
        ...
        $attributes = array(
            ...
            'titleLgTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'28','xs'=>'18', 'unit'=>'px'], 'height'=>(object)[ 'lg'=>'32', 'unit'=>'px'],'decoration'=>'none','family'=>'','weight'=>'700'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
                        ],
                        'selector'=>'{{ULTP}} .ultp-block-item:first-child .ultp-block-title, {{ULTP}} .ultp-block-item:first-child .ultp-block-title a, {{ULTP}} .ultp-layout4 .ultp-block-item:nth-child(4) .ultp-block-title, {{ULTP}} .ultp-layout4 .ultp-block-item:nth-child(4) .ultp-block-title a'
                    ],
                ],
            ],
            'titleTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'20', 'xs'=>'14', 'unit'=>'px'], 'height'=>(object)['lg'=>'26', 'unit'=>'px'], 'decoration'=>'none','family'=>'','weight'=>'600'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
                        ...
                        'selector'=>'{{ULTP}} .ultp-block-items-wrap:not(.ultp-layout4)  .ultp-block-item:not(:first-child) .ultp-block-title, {{ULTP}} .ultp-block-items-wrap:not(.ultp-layout4) .ultp-block-item:not(:first-child) .ultp-block-title a, {{ULTP}} .ultp-layout4 .ultp-block-item:not(:first-child):not(:nth-child(4)) .ultp-block-title, {{ULTP}} .ultp-layout4 .ultp-block-item:not(:first-child):not(:nth-child(4)) .ultp-block-title a
                        '
                    ],
                ],
            ],
