...
class Post_List_4{
    ...
    public function get_attributes($default = false) {
        ...
        $attributes = array(
            ...
            'titleColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-all-postlist-2 .ultp-block-content .ultp-block-title a { color:{{titleColor}} !important; }'
                    ],
                ],
            ],
            'titleHoverColor' => [
            ...
            'titleLgTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'20', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'0', 'unit'=>'px'], 'height'=>(object)[ 'lg'=>'26', 'unit'=>'px'],'decoration'=>'none','transform' => '','family'=>'','weight'=>'500'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
            ...
            'lgTitleColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-first-postlist-2 .ultp-block-content .ultp-block-title a { color:{{lgTitleColor}} !important; }'
                    ],
                ],
            ],
            'titleTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'16', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'0', 'unit'=>'px'], 'height'=>(object)['lg'=>'24', 'unit'=>'px'],'transform' => '', 'decoration'=>'none','family'=>'','weight'=>'500'],
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'titleShow','condition'=>'==','value'=>true],
