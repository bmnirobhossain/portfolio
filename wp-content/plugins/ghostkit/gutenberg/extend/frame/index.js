                      ...
                      <Fragment>
                        ...
                        {borderStyle ? (
                          <div className="ghostkit-control-border-additional">
                            <Tooltip text={__('Border Color', 'ghostkit')}>
                              <div>
                                <ColorPicker
                            ...
                            <Tooltip text={__('Border Size', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(`${borderPropName}Width`, device)}
                                  placeholder={__('Border Size', 'ghostkit')}
                                  onChange={(val) =>
                                    this.updateFrame(
                                      {
                        ...
                        <BaseControl label={__('Border Radius', 'ghostkit')}>
                          <div className="ghostkit-control-radius">
                            <Tooltip text={__('Top Left', 'ghostkit')}>
                              <div>
                                <InputDrag
                            ...
                            <Tooltip text={__('Top Right', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(
                            ...
                            <Tooltip text={__('Bottom Right', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(
                            ...
                            <Tooltip text={__('Bottom Left', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(
                        ...
                        <BaseControl label={__('Shadow', 'ghostkit')}>
                          <div className="ghostkit-control-box-shadow">
                            ...
                            <Tooltip text={__('X', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(`${shadowPropName}X`, device)}
                                  placeholder={__('X', 'ghostkit')}
                                  onChange={(val) =>
                                    this.updateFrame(
                                      {
                            ...
                            <Tooltip text={__('Y', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(`${shadowPropName}Y`, device)}
                                  placeholder={__('Y', 'ghostkit')}
                                  onChange={(val) =>
                                    this.updateFrame(
                                      {
                            ...
                            <Tooltip text={__('Blur', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(`${shadowPropName}Blur`, device)}
                                  placeholder={__('Blur', 'ghostkit')}
                                  onChange={(val) =>
                                    this.updateFrame(
                                      {
                            ...
                            <Tooltip text={__('Spread', 'ghostkit')}>
                              <div>
                                <InputDrag
                                  value={this.getCurrentFrame(`${shadowPropName}Spread`, device)}
                                  placeholder={__('Spread', 'ghostkit')}
                                  onChange={(val) =>
                                    this.updateFrame(
                                      {
