...
class BlockEdit extends Component {
  ...
  getStylesPicker() {
    ...
    const { style, styleCustom } = attributes;
        ...
        <InspectorControls>
          {this.state.apiKey ? (
            <Fragment>
                    ...
                    {markers.map((marker, index) => (
                      ...
                      <li key={index}>
                        <SearchBox
                          ...
                          value={
                            marker.address || this.state.addresses[marker.lat + marker.lng] || ''
                          }
                          onChange={(value) => {
                            if (value && value[0]) {
              ...
              <PanelBody title={__('Style', 'ghostkit')}>{this.getStylesPicker()}</PanelBody>
          ...
          <PanelBody title={__('API Key', 'ghostkit')} initialOpen={!this.state.apiKey}>
            <TextControl
